...
class coreapi {
  ...
  public function embed() {
    ...
    switch ($this->embed_type) {
      ...
      default:
        $output = '
        <object width="' . floor($this->embed_width) . '" height="' . floor($this->embed_height) . '">
        <param name="movie" value="http://au.teacherstv.ca/v/4HoqdBPoetTd7W7VDo88cR"></param>
        <param name="allowFullScreen" value="true"></param>
        <embed src="' .$this->get_flash_url() . '" type="application/x-shockwave-flash" allowfullscreen="true" width="920" height="512"></embed></object>
